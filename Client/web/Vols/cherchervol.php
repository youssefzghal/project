...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title">Les Vols Disponibles </div>
		</div>
	</div>
...
if (isset($_POST['depart']) and isset($_POST['destination']) and isset($_POST['datee'])){
	$volc=new VolCore();
    $result=$volc->searchVols($_POST['datee'],$_POST['depart'],$_POST['destination']);
	$i=0;
	echo $i;
							...
							<div class="row">
								...
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price"><?PHP echo $compagnie ?><span><?PHP echo $reff ?></span></div>
										...
										<div class="button book_button"><a href="ajouterreservation.php?idvol=<?PHP echo $reff ?>">Reserver une Billet<span></span><span></span><span></span></a></div>
										<div class="offer_reviews">
											<div class="offer_reviews_content">
												<div class="offer_reviews_title"></div>
												<div class="offer_reviews_subtitle">100 Avis</div>
											</div>
...
<?PHP }   
if($i==0) { ?>
<center><div class="blog_post_title" style="font-size: 72px" ><a href="#">Accun Vols Disponibles</a></div> </center> <br> <br> <br> <br> 
<?PHP } } ?>
						<!-- Offers Item -->
