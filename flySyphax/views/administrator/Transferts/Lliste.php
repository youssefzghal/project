                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="Chauffeurs">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="../Chauffeurs/Liste.php">Tous les chauffeurs</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link  " href="../Chauffeurs/Ajouter.php">Ajouter</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="../Chauffeurs/stats.php">Statistiques</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="transferts">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="LListe.php">Tous les Transferts</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="statss.php">Statistiques</a>
                            </li>
                        </ul>
                    </div>
                </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="col-sm-6 col-md-4 col-lg-3">
                                        <?PHP if($row['etat']=="Confirmé") { ?>  <i class="fa fa-vcard-o" style="color :green;">Confirmé</i></div>
                                    <?PHP } else { ?>
                                    <a href="confirm.php?id=<?PHP echo $row['id']; ?>"<i class="fa fa-vcard-o">Confirmer</i></a></div>
                                     <?PHP } ?>

                                </td>
                                <td>
                               <a href="delete.php?id=<?PHP echo $row['id']; ?>" <i class="fa fa-vcard-o"></i>Supprimer</a>
                                </td>
                            </tr>
