...
$cCore=new reservationVCore();
$liste=$cCore->getAllRVols();
...
<div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#CompagnieAérienne" aria-expanded="false" aria-controls="CompagnieAérienne">
                        ...
                        <span class="menu-title">Reservation de Vols</span>
                    ...
                    <div class="collapse" id="CompagnieAérienne">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="reservation.php">Liste Reservation</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="rstats.php">Statistiques</a>
                            </li>
        ...
        <div class="main-panel">
            <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                    <h4 class="card-title">Nombre de reservation par année</h4>
                    <canvas id="barChart" style="height: 222px; display: block; width: 444px;" width="888" height="444" class="chartjs-render-monitor"></canvas>
                </div>
            </div>
        ...
        <script>  var data = {
                ...
                datasets: [{
                    label: '#Nombre ',
                    data: [<?php echo nombreParAnnee("2016") ?>, <?php echo nombreParAnnee("2017") ?>, <?php echo nombreParAnnee("2018") ?>, <?php echo nombreParAnnee("2019") ?>, <?php echo nombreParAnnee("2020") ?>, <?php echo nombreParAnnee("2021") ?>, <?php echo nombreParAnnee("2022") ?>, <?php echo nombreParAnnee("2023") ?>],
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
                        'rgba(255, 206, 86, 0.2)',
        ...
        <script src="../../js/ajouterchauffeur.js"></script>
