...
<div class="icons-list row">
                 <div class="col-sm-6 col-md-4 col-lg-3">
                      <i class="fa fa-search"></i><input type="text" id="myInput" onkeyup="myFunction(this,2,1)" placeholder="chercher nom hotel.." class="form-control"> </div>
                      <div class="col-sm-6 col-md-4 col-lg-3">
                      <i class="fa fa-search"></i><input type="text" id="myIn" onkeyup="myFunction(this,8,0)" placeholder="chercher nomclient.." class="form-control"> </div>
                    </div>
...
foreach($listeresrvation as $row){
  ...
  <tr>
   <td><form method="POST" action="supprimerreservation.php">
  <input type="submit"  class="btn btn-success mr-2" name="supprimer" value="supprimer">
  <input type="hidden" value="<?PHP echo $row['idhotel']; ?>" name="idres">
  </form>
  </td>
