...
$listeresrvation=$res->afficherreservation();
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">ville les plus touristiques</h4>
                  <form class="form-sample" >
                     <center><img src="../views/monimage1.png"></center>
                  </form>
                </div>
              </div>
            </div>
...
foreach($listeresrvation as $row){
  ...
  <td><a href="modifierhotel.php?id=<?PHP echo $row['idres']; ?>">
  Modifier</a></td> 
