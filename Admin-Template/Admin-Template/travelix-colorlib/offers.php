...
foreach($listehotels as $row){
 ...
 $image='background-image:url(images/'.$row['image'].')';
 $url=$row['url'];
					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="favoris.php"><?php echo $favoris ?></a></li>
							</ul>
						</div>
									...
									<div class="offers_content">
										...
										<div class="offers_icons">
											<ul class="offers_icons_list">
												...
												<li class="offers_icons_item"><form method="post" action="ajouterfav.php" onsubmit="<?php echo $retour ?>">

                                                  <input type="hidden" name="idh" value="<?php echo $id ?>">
                                                   <input type="hidden" name="idc" value="<?php echo $idcl ?>">

                                                    


													<button type="submit" name="fav"><img  name="im1" src="<?php echo $coeur ?>" onclick="changer(this)"  alt=""></button></form></li>
...
function changer(input)
{
	...
	input.src='images/coeurb11r.png'
}
