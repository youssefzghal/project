	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<li class="menu_item"><a href="monespace.php">mon espace</a></li>
			</ul>
		</div>
	</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						<div class="contact_title text-center">connexion</div>
						<form action="connexion.php" id="contact_form" class="contact_form text-center" method="post">
							<input type="text" id="login" name="login" class="contact_form_name input_field" placeholder="login" required="required" data-error="login is required.">
							<input type="Password" id="pwd" name="pwd" class="contact_form_email input_field" placeholder="password" required="required" data-error="password is required.">
						
							<button type="submit" name="button" id="form_submit_button" class="form_submit_button button trans_200" value="valider">valider<span></span><span></span><span></span></button>
						</form>
					</div>
