...
$i++;	
 $nbetoiles=substr($row['categorie'],0,1);
 $offers='offers_item rating_'.$nbetoiles;
 $image='background-image:url(images/'.$row['image'].'.jpg)';
 $url=$row['url'];
 $prix='$'.$row['prixdoubles'];
 $raiting='rating_r rating_r_'.$nbetoiles.' offers_rating';
					...
					<div class="row fill_height no-margin">
						<div class="col fill_height no-padding">
							...
							<div class="search_panel active">
								<form action="#"  id="search_form_1" name="f" onsubmit="return test2()" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                              ...
                              <option  value="all">All</option>
                             	 <option  value="Tunis">Tunis</option>  
									...
									<div class="search_item">
										<div>check in</div>
										<input id="date" name="date1" class="check_in search_input" type="date" oninput="test()" >
									</div>
									<div class="search_item">
										<div>check out</div>
										<input id="date3" name="date2" class="check_out search_input" type="date" oninput="test()">
									</div>
									...
									<div class="search_item">
										<div>adults</div>
										<input type=number name="nbadulte" class="check_out search_input " min="1" required>
									</div>
									<div class="search_item">
										<div>children</div>
									...
									<div class="search_item">
										<div>categorie</div>
										<select class="dropdown_item_select search_input" id="nbetoiles" name="nbetoiles">
                      ...
                      <option>5 etoiles</option>
									...
									<input type="submit"  value="Search" class="button search_button"> 
								</form>
							</div>
				...
				<div class="col-lg-11">
					...
					<div class="offers_sorting_container">
						<ul class="offers_sorting">
									...
									<div class="milestone_icon"><img src="images/milestone_1.png" alt=""></div>
									<div class="milestone_counter" data-end-value="255"><?php echo $i ?></div>
							...
							<li>
								...
								<ul>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "original-order" }' data-parent=".price_sorting"><span>tout</span></li>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "price" }' data-parent=".price_sorting"><span>croissant</span></li>
								</ul>
							</li>
							<li>
								<span class="sorting_text">ville</span>
								<i class="fa fa-chevron-down"></i>
								<ul>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "original-order" }'><span>defaut</span></li>
									<li class="sort_btn" data-isotope-option='{ "sortBy": "name" }'><span>alphabet</span></li>
								</ul>
							</li>
							<li>
								<span class="sorting_text">Etoiles</span>
								<i class="fa fa-chevron-down"></i>
								<ul>
									<li class="filter_btn" data-filter="*"><span>tous</span></li>
...
if ( isset($_GET['ville']) and isset($_GET['nbetoiles']) and isset($_GET['date1']) and isset($_GET['date2'])   )
...
if(($vi!="all") and ($nb=='toutes categories') )

                        {$listehotels=$hotel1C->rechercherListehotel($vi); }


          
          if(($vi!="all") and ($nb!='toutes categories'))

                        {$listehotels=$hotel1C->rechercherselonvillecategorie($vi,$nb); } 


                     if(($vi=="all") and ($nb!='toutes categories'))

                        {$listehotels=$hotel1C->rechercherseloncategorie($nb); }
 ...
 $nomv=$nom.'/ '.$ville;
    ...
    ?>                    
						<div class="<?php echo $offers ?>">
							<div class="row">
								<div class="col-lg-1 temp_col"></div>
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										<!-- Image by https://unsplash.com/@kensuarez -->
										<div class="offers_image_background" style="<?php echo $image ?>"></div>
										<div class="offer_name">
											<a href="<?php echo $url ?>"><?php echo $nom ?></a>
								...
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price"><?php echo $prix ?><span>par nuit</span></div>
										<div class="<?php echo $raiting ?>" data-rating="<?php echo $nbetoiles ?>">
											<i></i>
											<i></i>
											<i></i>
											<i></i>
										...
										<p class="offers_text"><?php echo $description ?></p>
										<div class="offers_icons">
											<ul class="offers_icons_list">
												<li class="offers_icons_item"><span style="text-transform: uppercase;font-weight: 900; color: #eda84a;"><?php echo $ville ?></span></li>
												<li class="offers_icons_item"><img src="images/compass.png" alt=""></li>
												<li class="offers_icons_item"><img src="images/bicycle.png" alt=""></li>
												<li class="offers_icons_item"><img src="images/sailboat.png" alt=""></li>
											</ul>
										</div>
										<div class="button book_button"><a href="resa.php?id=<?PHP echo $id; ?>
										&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>&nbnuit=<?php echo $nbnuit ?>">reserver<span></span><span></span><span></span></a></div>
										<div class="offer_reviews">
											<div class="offer_reviews_content">
												<div class="offer_reviews_title"><?php echo $avis ?></div>
												<div class="offer_reviews_subtitle">100 reviews</div>
											</div>
											<div class="offer_reviews_rating text-center"><?php echo $note ?></div>
										</div>
									</div>
								</div>
							</div>
