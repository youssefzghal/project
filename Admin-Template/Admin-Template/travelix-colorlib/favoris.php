...
$listehotels=$hotel1C->recupererhotelfav($idcl);
...
if(($vi!="all") and ($nb=='toutes categories') )
                        ...
                        {$listehotels=$h->rechercherListehotel($vi); }


          
          if(($vi!="all") and ($nb!='toutes categories'))

                        {$listehotels=$h->rechercherselonvillecategorie($vi,$nb); } 


                     if(($vi=="all") and ($nb!='toutes categories'))

                        {$listehotels=$h->rechercherseloncategorie($nb); }
							...
							<div class="row">
								...
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<div class="button book_button"><a href="supprimerfav.php?idcc=<?PHP if(isset($idcl)){ echo $idcl ;} ?>&idhh=<?php echo $id ?>"><?php echo $sup ?><span></span><span></span><span></span></a></div>
