                 ...
                 <input type="text" name="nom" value="<?php echo $nomhotel ?>" class="check_out search_input " readonly >
                  ...
                  <div class="search_item">
                   ...
                   <input type="text" name="total" value="<?php echo $prixdoubles ?>" class="check_out search_input " readonly required>
                     ...
                     <div class="search_item">
                    <div>telephone</div>
                   <input type="text" name="telephone" value="<?php if(isset($telephone)){echo $telephone;}?>" class="check_out search_input "  pattern="[0-9]{8}" required 
...
<div class="search_item">
                    <div>nom</div>
                   <input type="text" name="nomclient"  class="check_out search_input " pattern="[A-Za-z]{2,}"required title="le nom ne doit pas contenir des caractere speciaux ou nombres(min 2Lettres)" value="<?php if(isset($nom)){echo $nom;}?>" >
                  </div>
            ...
            <div class="search_item">
                    <div>prenom</div>
                   <input type="text" name="prenomclient"  class="check_out search_input "pattern="[A-Za-z]{2,}" required title="le nom ne doit pas contenir des caractere speciaux ou nombres(min 2 lettres)" value="<?php if(isset($prenom)){echo $prenom;}?>" >
                  </div>
            ...
            <div class="search_item">
                   ...
                   <input type="email" name="email"  class="check_out search_input " value="<?php if(isset($email)){echo $email;}?>" required>
                  </div>
...
{$nomhotel=$_GET['nom'];
 ...
 $total=$_GET['total'];
 $to=$_GET['email'];
 //$date11=$resrvation->formaterdate($date1);
 //$date22=$resrvation->formaterdate($date2);
$datei=date_create($date1);
$date11= date_format($datei,"l jS \of F Y");
$dateii=date_create($date2);
$date22= date_format($dateii,"l jS \of F Y");

  $n='bonjour ,'.$nomclient.' '.$prenomclient;
    $n1=',votre reservation du '.$date11. '('.$date1.') jusqua '.$date22 .'('.$date2.')'.' est effectue avec succes ';
    $n2=',hotel: '.$nomhotel;
    $n3=',total: '.$total.'DNT';
...
$verif=$resrvation->verifierdisponible($reservation1,$message);

if($verif==true)
{
  
  $resrvation->ajouter_reservation($reservation1);
      $max=$resrvation->recupererid();
      $messageemail=$messageemail.',Ref reservation:'.$max;
      //mail
            ...
            <div class="footer_content footer_contact">
              <ul class="contact_info_list">
                <li class="contact_info_item d-flex flex-row">
                  ...
                  <div class="contact_info_text"><a href="carte.php">lac 2  rue lac leman 55</a></div>
                </li>
                <li class="contact_info_item d-flex flex-row">
          ...
          <div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
            <div class="footer_nav">
              <ul class="footer_nav_list">
                ...
                <li class="footer_nav_item"><a href="monespace.php">news</a></li>
