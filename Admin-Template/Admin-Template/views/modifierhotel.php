...
if (isset($_GET['id'])){
	...
	foreach($result as $row){
        ...
        $nom=$row['nom']; 
        $ville=$row['ville']; 
   		$nbetoiles=$row['categorie']; 
  		$note=$row['note']; 
 		$review=$row['review']; 
        $ch2=$row['chambresdoubles']; 
   		$ch3=$row['chambrestriples']; 
   		$total=$row['totalchambres']; 
   		$prixd=$row['prixdoubles']; 
   		$prixt=$row['prixtriples']; 
 		$image= $row['image']; 
   		$url=$row['url'];
    	$msg=$row['description'];
   	    ...
   	    ?>
                  <form class="form-sample" method="post" name="f" id="f" >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="number" class="form-control" name="idhotel" value="<?PHP echo $idhotel ?>" readonly required>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <table><tr>
                              ...
                              <option><?PHP echo $nbetoiles ?></option>
                      ...
                      <option>very good</option>
                             ...
                             <td>
                                 Note<input type="number" name="note"  class="form-control" value="<?PHP echo $note ?>" min="1" max="10">
                            </td>
                          </tr>
                          </table>
                          </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                           ...
                           <table>
                             ...
                             <tr>
                              <td>Doubles<input type="number" id="ch2" name="ch2"  min="1" max="200" class="form-control" 
                              	value="<?PHP echo $ch2 ?>" required oninput="somme()"></td><td></td><td></td>
                               <td>Triples<input type="number" id="ch3" name="ch3"  min="1" max="200" class="form-control" 
                               	value="<?PHP echo $ch3 ?>" required oninput="somme()"></td><td></td><td></td>

                               <td>Total<input type="number" id="total" name="total"  class="form-control" value="<?PHP echo $total ?>"readonly></td>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             <input type="email" id="email_addr" name="email_addr" class="form-control" 
                             value="<?PHP echo $email_addr ?>" required>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea id="msg" name="msg" class="form-control"  required><?PHP echo $msg ?></textarea>
       ...
       onblur="check(this)" onfocus="che(this)">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="Number" step="any" id="longitude" name="longitude" class="form-control"  required  value="<?PHP echo $longitude ?>">
                   ...
                   <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="file" id="image" name="image" value="<?PHP echo $image ?>" class="form-control" required >
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="url" name="url" id="url" class="form-control" placeholder="https://example.com"  
                                  value="<?PHP echo $url ?>" pattern="https://.*" size="30" required>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                             ...
                             <select name="ville" id="ville" class="form-control" required onchange="remplir(this)">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <table>
                            <tr><td> Doubles </td><td></td><td><input type="number" class="form-control" id="prixd" name="prixd"  value="<?PHP echo $prixd ?>" min="1" max="2000"  required ></td><td> </td><td> </td>
                             <td> latitude </td><td></td><td><input type="number" step="any" class="form-control" id="prixt" name="prixt"  
                             value="<?PHP echo $prixt ?>" min="1" max="2000" required ></td>
                            </tr>
                            </table>
                          </div>
                        </div>
					...
					<center>
						 <input type="submit" name="modifier" value="modifier" class="btn btn-success mr-2">
...
$hotel=new hotel($_POST['idhotel'],$_POST['nom'],$_POST['ville'],$_POST['nbetoiles'],$_POST['note'],$_POST['review'],$_POST['ch2'],$_POST['ch3'],$_POST['total'],$_POST['prixd'],$_POST['prixt'],$_POST['image'],$_POST['url'],$_POST['msg'],$_POST['longitude'],$_POST['email_addr'] );
$hotelC->modifierhotel($hotel,$_POST['cin_ini']);
...
<tr>
 ...
 <td style="color:blue"></td> 
<td style="color:blue;font-weight:bold">ID</td>
<td style="color:blue;font-weight:bold">Nom</td>
<td style="color:blue;font-weight:bold">Ville</td>
<td style="color:blue;font-weight:bold">Categorie</td>
<td style="color: blue;font-weight:bold">Note</td>
<td style="color: blue;font-weight:bold">Review</td>
<td style="color: blue;font-weight:bold">Doubles</td>
<td style="color: blue;font-weight:bold">Triples</td>
<td style="color: blue;font-weight:bold">Total</td>
<td style="color: blue;font-weight:bold">Prix doubles</td>
<td style="color: blue;font-weight:bold">latitude</td>
<td style="color: blue;font-weight:bold">Image</td>
<td style="color: blue;font-weight:bold">longitude</td>
...
foreach($listehotel as $row){
  ...
  <td><a href="modifierhotel.php?cin=<?PHP echo $row['id']; ?>">
  Modifier</a></td>  
