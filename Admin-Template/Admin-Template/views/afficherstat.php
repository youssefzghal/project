...
$c='0';
$d='0';
if (array_key_exists('2-etoiles', $element)){$a=$element['2-etoiles'];}
if (array_key_exists('3-etoiles', $element)) {$b=$element['3-etoiles'];}
 if (array_key_exists('4-etoiles', $element)){$c=$element['4-etoiles'];}
  if (array_key_exists('5-etoiles', $element)){$d=$element['5-etoiles'];}
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" method="post" name="f" id="f" onsubmit=" return ajour()" action="ajouthotel.php">
                     ...
                     <br>
                          <label>2 etoiles</label> <label>  </label> <progress  value="<?php echo $a ?>"  max="<?php echo $total?>">
                   </progress><label ></label> <label><?php echo $a ?></label><br>
                   <label>3 etoiles</label>  <label>   </label><progress value="<?php echo $b ?>"  max="<?php echo $total?>">
                   </progress><label> </label>    <label><?php echo $b ?></label><br>
                   <label>4 etoiles</label>  <label>   </label><progress value="<?php echo $c ?>"  max="<?php echo $total?>">
                   </progress><label> </label> <label><?php echo $c ?></label><br>
                     <label>5 etoiles</label>   <label>    </label><progress value="<?php echo $d ?>"  max="<?php echo $total?>">
                   </progress><label>   </label>  <label><?php echo $d ?></label><br>
                  </form>
