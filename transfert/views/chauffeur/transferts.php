...
if (isset($_SESSION['login']) && isset($_SESSION['motDePasse']))
{
    ...
    $liste1=$cCore->searchTransfertConfirmedNext($_SESSION['login']);
    $liste2=$cCore->searchTransfertConfirmedOld($_SESSION['login']);
            ...
            <div class="content">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Prochain Transferts ( Nouveaux ) </h4>
                                <p class="category"> </p>
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Transferts éffectués ( Anciens )</h4>
                                <p class="category"> </p>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive ps">
