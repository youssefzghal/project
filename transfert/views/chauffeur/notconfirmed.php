...
if (isset($_SESSION['login']) && isset($_SESSION['motDePasse']))
{
    ...
    $liste=$cCore->searchTransfertNotConfirmed($_SESSION['login']);
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Les demandes de transferts pour</h4>
                                <p class="category"><?php echo $_SESSION['login']; ?></p>
                            </div>
                            <div class="card-body">
    ...
    foreach($liste as $row){
        ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="margin-left : 14%;"  class="tim-icons icon-check-2" href="confirm.php?id=<?PHP echo $row['id']; ?>"></a>
                                            </td>
                                        </tr>
