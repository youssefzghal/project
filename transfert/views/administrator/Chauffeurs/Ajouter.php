                ...
                <div class="card-body">
                  ...
                  <form class="form-sample">
                          ...
                          <div class="col-md-6">
                              <div class="form-group row">
                                  <label class="col-sm-3 col-form-label">
                                      <img id="selectedphoto" style=" margin-left: 10%; border-radius: 50%;" src="../resources/images/faces/face1.jpg" alt="profile image">
                                  </label>
                                  <div class="col-sm-9">
                                      ...
                                      <input type="text" class="form-control file-upload-info" disabled="" placeholder="Télécharger Image">
                                       <span class="input-group-append">
                                        <button class="file-upload-browse btn btn-info" type="button" onclick="photoAdd()">Télécharger</button>
                                         ...
                                         <input id="inputphoto" required title="Veuillez inserer une image" accept="image/gif, image/jpeg, image/png" type="file" name="photo" style="   font-size: 100px; position: absolute; left: 0; top: 0; opacity: 0;">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="pnom" required type="text" class="form-control" >
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                          <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                  <div class="form-radio">
                                      <label class="form-check-label">
                                          <input type="radio" class="form-check-input" name="sexe" id="membershipRadios1" value="Masculin" checked=""> Masculin
                              ...
                              <div class="col-sm-5">
                                  <div class="form-radio">
                                      <label class="form-check-label">
                                          <input type="radio" class="form-check-input" name="sexe" id="membershipRadios2" value="Féminin"> Féminin
                                          <i class="input-helper"></i></label>
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="daten" required type="date" class="form-control"   max="1999-01-01" min="1960-01-01" value="1999-01-01" title="Date de naissance n'est pas valide">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="adresse1" required type="text" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input  name="adresse2" type="text" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="ville" required type="text" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="cin" required type="text" class="form-control">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="telephone" required pattern="{8}" title="doit contenir  au moins 8 lettres"  type="number" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-description">
                        Créer un nouveau chauffeur login
                      </p>
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input required type="text" name="login" class="form-control" placeholder="Login *" aria-label="Username" aria-describedby="colored-addon1">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <input required type="password" name="motdepasse"  placeholder="Mot de Passe *"  pattern="{8}" title="doit contenir  au moins 8 lettres" class="form-control" aria-label="Username" aria-describedby="colored-addon2">
                        </div>
                      </div>
                      ...
                      <center>
				  <button type="submit" class="btn btn-success mr-2" name="ajouter" id="ajouter" >Ajouter</button>
                      </center>
                  </form>
                </div>
              </div>
